...
public class RankCalculator {
        ...
        for (CSVRecord record : fr.getCSVParser(false)){
            ...
            if (record.get(0).equals(name) && record.get(1).equals(gender)){
                ...
                if (gender.equals("F")){
                    ...
                    rankNameInput = rankStart - (numberCalculator.numberNamesGender(fr, "F"));
                }
            }
        }
    ...
    public int yearOfHighestRank(String name, String gender){
        ...
        for (File f : listOfFiles){
            ...
            if (highestRank == 0 && currentRank != -1){
                if (currentRank < numberCalculator.numberNamesGender(fr, gender)){
    ...
    public int getTotalBirthsRankedHigher(String name, String gender, int year){
        ...
        FileResource fr = new FileResource("us_babynames/yob"+year+".csv");
        int totalNamesF = numberCalculator.numberNamesGender(fr, "F");
